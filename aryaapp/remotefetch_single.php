...
if(isset($_POST["product_id"]))
{
	...
	foreach($result as $row)
	{
		...
		if($row["image"] != '')
		{
			$output['product_image'] = '<img src="http://aryafireandsafety.com/aryaapp/upload/'.$row["image"].'" class="img-thumbnail" width="50" height="35" /><input type="hidden" name="hidden_product_image" value="'.$row["image"].'" />';
		}
		else
		{
